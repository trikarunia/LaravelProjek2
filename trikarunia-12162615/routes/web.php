...
Route::group(['prefix' => 'view'], function() {
    Route::get('/..', 'ProductControllerBS@index');
    Route::get('/../new', 'ProductControllerBS@create');
    Route::post('/..', 'ProductControllerBS@save');
    Route::get('/../{id}', 'ProductControllerBS@edit');
    Route::put('/../{id}', 'ProductControllerBS@update');
    Route::delete('/../{id}', 'ProductControllerBS@destroy');
